...
* **Lack of Metrics:** Not knowing how much time is actually spent studying versus how much progress is made.
* **Resource Scattering:** Notes, links, and PDFs are often scattered across different platforms.
...
* **Progress Tracking:** Mark topics as "Pending," "In Progress," or "Completed" and visualize completion rates.
* **Study Timer:** Built-in timer (Pomodoro style) to log actual study hours against specific topics.
